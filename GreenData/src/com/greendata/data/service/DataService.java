...
public class DataService extends WorkerService{
	...
	public static final String INTENT_EXTRA_WORKER = "com.greendata.extras.worker";
	...
	protected void onHandleIntent(Intent intent) {
		DataWorker worker = intent.getParcelableExtra(DataService.INTENT_EXTRA_WORKER);
		DataQuery query = intent.getParcelableExtra(DataService.INTENT_EXTRA_QUERY);
		try {
